...
protocol ChatHandlerProtocol {
    var delegate : ChatHandlerDelegate?{get set}
    ...
    //获取会话列表
    func getSessionList(page : Int32 , count : Int32,success :@escaping ChatDataBlock<ChatSessionResult>,fail :@escaping ChatFailBlock)
    
    //获取消息列表
    func getMsgList(page : Int32 , count : Int32,session : DGCChatSession,success :@escaping ChatDataBlock<ChatMsgResult>,fail :@escaping ChatFailBlock)
...
protocol ChatHandlerDelegate {
    ...
    //收到新消息
    func onRecvNewMsg(msg : DGCChatMsg,sessionID : String,sessionType : ChatSessionType,sender:String)
    
    //消息修改
    func onRecvMsgModified(msg : DGCChatMsg,sessionID : String,sessionType : ChatSessionType, sender:String)
...
public protocol ChatSessionDelegate : NSObjectProtocol {
    //刷新消息列表
