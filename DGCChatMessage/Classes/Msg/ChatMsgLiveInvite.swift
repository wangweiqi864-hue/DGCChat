...
//        try dgc_container.encode(gameIcon, forKey: .gameIcon)
    ...
    required public init(from decoder: Decoder) throws {
        ...
        roomId = (try? dgc_container.decode(Int64.self, forKey: .roomId)) ?? 0
        roomId2 = (try? dgc_container.decode(Int64.self, forKey: .roomId2)) ?? 0
        roomId2Eid = (try? dgc_container.decode(Int64.self, forKey: .roomId2Eid)) ?? 0
        name = (try? dgc_container.decode(String.self, forKey: .name)) ?? ""
        icon = (try? dgc_container.decode(String.self, forKey: .icon)) ?? ""
        patternType = (try? dgc_container.decode(Int.self, forKey: .patternType)) ?? 0
//        gameIcon = (try? dgc_container.decode(String.self, forKey: .gameIcon)) ?? ""
//        gameName = (try? dgc_container.decode(String.self, forKey: .gameName)) ?? ""
    }
}
